...
<template>
  <section class="max-w-4xl p-6 mx-auto rounded-md border-2 shadow-md dark:bg-gray-800 mt-20">
    <h1 class="text-xl font-bold text-grey-800 capitalize dark:text-grey-800">
      Account settings
    </h1>
    <form>
      <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="username">Username</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="emailAddress">Email Address</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="password">Password</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="passwordConfirmation">Password Confirmation</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="passwordConfirmation">Color</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="passwordConfirmation">Select</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="passwordConfirmation">Range</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="passwordConfirmation">Date</label>
        ...
        <div>
          <label class="text-grey-800 dark:text-gray-200" for="passwordConfirmation">Text Area</label>
          <textarea id="textarea" type="textarea" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
        </div>
        <div>
          <label class="block text-sm font-medium text-grey-800">
            Image
          </label>
          <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
            <div class="space-y-1 text-center">
              <svg class="mx-auto h-12 w-12 text-grey-800" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <div class="flex justify-end mt-6">
        <button class="px-6 py-2 leading-5 text-grey-800 transition-colors duration-200 transform bg-pink-500 rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600">
          Save
        </button>
      </div>
    </form>
